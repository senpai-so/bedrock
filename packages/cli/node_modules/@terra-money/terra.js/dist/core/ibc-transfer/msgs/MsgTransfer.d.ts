...
export declare class MsgTransfer extends JSONSerializable<MsgTransfer.Amino, MsgTransfer.Data, MsgTransfer.Proto> {
     ...
     */
    constructor(source_port: string, source_channel: string, token: Coin | undefined, sender: AccAddress, receiver: string, timeout_height: Height | undefined, timeout_timestamp: number);
    ...
    static fromProto(proto: MsgTransfer.Proto): MsgTransfer;
    toProto(): MsgTransfer.Proto;
    packAny(): Any;
    static unpackAny(msgAny: Any): MsgTransfer;
}
