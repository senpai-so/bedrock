...
export declare class MsgAggregateExchangeRateVote extends JSONSerializable<MsgAggregateExchangeRateVote.Amino, MsgAggregateExchangeRateVote.Data, MsgAggregateExchangeRateVote.Proto> {
    ...
    static fromAmino(data: MsgAggregateExchangeRateVote.Amino): MsgAggregateExchangeRateVote;
    toAmino(): MsgAggregateExchangeRateVote.Amino;
    static fromData(proto: MsgAggregateExchangeRateVote.Data): MsgAggregateExchangeRateVote;
    toData(): MsgAggregateExchangeRateVote.Data;
    static fromProto(proto: MsgAggregateExchangeRateVote.Proto): MsgAggregateExchangeRateVote;
    toProto(): MsgAggregateExchangeRateVote.Proto;
    /**
    ...
    packAny(): Any;
    static unpackAny(msgAny: Any): MsgAggregateExchangeRateVote;
}
