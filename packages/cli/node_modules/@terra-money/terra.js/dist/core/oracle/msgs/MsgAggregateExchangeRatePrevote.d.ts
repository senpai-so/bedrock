...
export declare class MsgAggregateExchangeRatePrevote extends JSONSerializable<MsgAggregateExchangeRatePrevote.Amino, MsgAggregateExchangeRatePrevote.Data, MsgAggregateExchangeRatePrevote.Proto> {
    ...
    static fromAmino(data: MsgAggregateExchangeRatePrevote.Amino): MsgAggregateExchangeRatePrevote;
    toAmino(): MsgAggregateExchangeRatePrevote.Amino;
    ...
    static fromProto(proto: MsgAggregateExchangeRatePrevote.Proto): MsgAggregateExchangeRatePrevote;
    toProto(): MsgAggregateExchangeRatePrevote.Proto;
    packAny(): Any;
    static unpackAny(msgAny: Any): MsgAggregateExchangeRatePrevote;
}
