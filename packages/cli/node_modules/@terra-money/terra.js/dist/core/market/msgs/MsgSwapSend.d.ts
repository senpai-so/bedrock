...
export declare class MsgSwapSend extends JSONSerializable<MsgSwapSend.Amino, MsgSwapSend.Data, MsgSwapSend.Proto> {
    ...
    static fromAmino(data: MsgSwapSend.Amino): MsgSwapSend;
    toAmino(): MsgSwapSend.Amino;
    static fromProto(proto: MsgSwapSend.Proto): MsgSwapSend;
    toProto(): MsgSwapSend.Proto;
    packAny(): Any;
    static unpackAny(msgAny: Any): MsgSwapSend;
