...
export declare class PeriodicAllowance extends JSONSerializable<PeriodicAllowance.Amino, PeriodicAllowance.Data, PeriodicAllowance.Proto> {
    ...
    static fromAmino(data: PeriodicAllowance.Amino): PeriodicAllowance;
    toAmino(): PeriodicAllowance.Amino;
    static fromData(proto: PeriodicAllowance.Data): PeriodicAllowance;
    toData(): PeriodicAllowance.Data;
    static fromProto(proto: PeriodicAllowance.Proto): PeriodicAllowance;
    toProto(): PeriodicAllowance.Proto;
    packAny(): Any;
    static unpackAny(msgAny: Any): PeriodicAllowance;
}
