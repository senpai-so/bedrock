...
export function createRepo(print, codecs, options = {}) {
  ...
  return create(repoPath, codeOrName => codecs.getCodec(codeOrName), {
    root: new FsDatastore(repoPath, { extension: '' }),
    blocks: new BlockstoreDatastoreAdapter(new ShardingDatastore(new FsDatastore(`${ repoPath }/blocks`, { extension: '.data' }), new NextToLast(2))),
