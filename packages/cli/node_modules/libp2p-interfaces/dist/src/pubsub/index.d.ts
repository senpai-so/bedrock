...
declare class PubsubBaseProtocol extends EventEmitter {
     ...
     * @abstract
     */
    constructor({ debugName, multicodecs, libp2p, globalSignaturePolicy, canRelayMessage, emitSelf, messageProcessingConcurrency }: PubsubProperties & PubsubOptions);
    log: debug.Debugger & {
        err: debug.Debugger;
    };
    /**
...
declare namespace PubsubBaseProtocol {
    export { utils, SignaturePolicy, Libp2p, PeerId, BufferList, MuxedStream, Connection, SignaturePolicyType, IRPC, RPCSubOpts, RPCMessage, InMessage, PubsubProperties, PubsubOptions };
}
