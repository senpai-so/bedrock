...
import * as OlympusStakingContract from '../build/OlympusStakingV2.json'
import * as StakingHelperContract from '../build/OlympusStakingHelper.json'

const OlympusStakingABI = OlympusStakingContract.abi
const StakingHelperABI = StakingHelperContract.abi

// import { OlympusStakingv2, StakingHelper } from '../build/typechain'
...
export async function stake({
  ...
  try {
    ...
    if (stakeTx) {
      ...
      console.log(event)
      // console.log(clearPendingTxn(stakeTx.hash))
    }
  }
}
